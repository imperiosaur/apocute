...
{% include spoiler.html id="ThirtyFive" name="How does Robert Clement's position work?" content="One baseball position can obliquely describe the transformation that has happened to one word in each of the clues. (This is probably the weakest connection out of all of them, but this position was hard to do.)" %}
